                ...
                <ul class="main-categories">
                    <li class="main-nav-list">
                        <a data-toggle="collapse" href="#fruitsVegetable" aria-expanded="false"
                            ...
                            Vegetables<span class="number">(53)</span>
                        </a>
                    ...
                    <form action="">
                        <ul>
                            <li class="filter-list">
                                <input class="pixel-radio" type="radio" name="apple" name="brand">
                                <label for="apple">Apple<span>(29)</span></label>
                            </li>
                            <li class="filter-list">
                                <input class="pixel-radio" type="radio" name="asus" name="brand">
                                <label for="asus">Asus<span>(29)</span></label>
                            </li>
                            <li class="filter-list">
                                <input class="pixel-radio" type="radio" name="gionee" name="brand">
                                <label for="gionee">Gionee<span>(19)</span></label>
                            </li>
                            <li class="filter-list">
                                <input class="pixel-radio" type="radio" name="micromax" name="brand">
                                <label for="micromax">Micromax<span>(19)</span></label>
                            </li>
                            <li class="filter-list">
                                <input class="pixel-radio" type="radio" name="samsung" name="brand">
                        ...
                        <div class="single-product">
                            ...
                            <div class="product-details">
                                ...
                                <a class="d-flex justify-content-between">
                                    <div class="">
                                        <i class="ti ti-dashboard"></i> {{$product->engine_hours}}
                                    </div>
                                    <div class="">
                                        <i class="ti ti-calendar"></i> {{$product->yop}}
                                    </div>
                                    <div class="">
                                ...
                                <div class="prd-bottom">
                                    <a href="{{route('wish.create',['product_id'=>$product->id])}}" class="social-info">
